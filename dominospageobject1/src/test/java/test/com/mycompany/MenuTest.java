...
public class MenuTest {
  ...
  @Test
    public void TestMenutwo() throws Exception {

        driver.get("https://www.dominos.com/en/");
        driver.manage().window().maximize();
        driver.findElement(By.cssSelector("#__next > header > div > nav > ul:nth-child(1) > li:nth-child(4) > a")).click();
        

        driver.findElement(By.xpath("//div[@id='js-categoryArea']/div/div[4]/a/div[2]/h2")).click();

        driver.findElement(By.xpath("//img[@alt='Buffalo Chicken Sandwich - Grilled chicken breast, creamy blue cheese sauce, fresh onions, hot buffalo sauce, provolone, cheddar and cheese made with 100% real mozzarella.​']")).click();
